...
fun TextField(
    ...
    colors: TextFieldColors = OutlinedTextFieldDefaults.colors(
        focusedTextColor = Theme.colorScheme.surfaceContainerHigh,
        unfocusedTextColor = Theme.colorScheme.surfaceContainerHigh,
        errorTextColor = Theme.colorScheme.surfaceContainerHigh,
        focusedContainerColor = Theme.colorScheme.surfaceContainerLow,
        unfocusedContainerColor = Theme.colorScheme.surfaceContainerLow,
        errorContainerColor = Theme.colorScheme.surfaceContainerLow,
        cursorColor = Theme.colorScheme.surfaceContainerHigh,
        errorCursorColor = Theme.colorScheme.error,
        focusedBorderColor = Theme.colorScheme.outline,
